...
# Model training
model.fit([X_train, decoder_input_data], y_train_pad, epochs=50, batch_size=64, validation_split=0.2)

# Step 8: Save the model and data splits
current_datetime = datetime.now().strftime("%Y%m%d_%H%M%S")
save_folder = f'model_{current_datetime}_deep_gpt_encoder_small'
