...
file_path = 'data/merged_features_with_explanation-small-without-CEG.csv'  # Change to your CSV file path
...
save_folder = f'model/model_{current_datetime}_deep_gpt_encoder_small-without-CEG'
