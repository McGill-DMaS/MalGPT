...
# Load the model
model = load_model('model/model_20241114_233916_deep_gpt_encoder_small-without-CEG/gpt_encoder_decoder_model.h5')
...
results_df.to_csv('result/evaluation_results-small_model_20241114_233916_deep_gpt_encoder_small-without-CEG.csv', index=False)
