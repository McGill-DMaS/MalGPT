...
file_path = 'data/merged_features_with_explanation-small-without-importexport.csv'
...
# Load the model
model = load_model('model/model_20241114_234849_deep_gpt_encoder_small-without-importexport/gpt_encoder_decoder_model.h5')
...
results_df.to_csv('result/evaluation_results-small_model_20241114_234849_deep_gpt_encoder_small-without-importexport.csv', index=False)
